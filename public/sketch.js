...
function setup() {
        ...
        //socket = io.connect('http://ec2-80-26-149-126.eu-west-3.compute.amazonaws.com:3000')
        socket = io.connect('http://80.26.149.126:3000')
        ...
        document.getElementById('exportar').addEventListener('click', () => {
                downloadCSVFile('Latencias_AWS WLZ_eu_west_3_pilot_1.csv', sum);
                //console.log(sum)
        });
