...
function setup() {
	...
	document.getElementById('exportar').addEventListener('click', () => {
		downloadCSVFile('Latencias_Wavelength.csv', sum);
		//console.log(sum)
	});
...
// 	const text = JSON.stringify(data); // convierte la matriz en una cadena de texto
// 	const blob = new Blob([text], { type: 'text/plain' }); // crea un objeto Blob
